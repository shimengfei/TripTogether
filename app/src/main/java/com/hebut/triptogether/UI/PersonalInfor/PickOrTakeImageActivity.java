...
public class PickOrTakeImageActivity extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener,
    ...
    //final Context mContext=AppContext.getInstance();
    /** 按时间排序的所有图片list */
    ...
    private class GridViewAdapter extends BaseAdapter{
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (bitmap != null){
                ...
                holder.iv_content.setBackgroundResource(R.mipmap.ic_product_9);
            }
            return view;
        }
    }
    ...
    private class ListviewAdapter extends BaseAdapter{
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (bitmap != null){
                ...
                holder.iv_directory_pic.setBackgroundResource(R.mipmap.ic_product_9);
            }
            return view;
        }
    }
